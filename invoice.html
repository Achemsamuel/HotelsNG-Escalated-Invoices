                ...
                <div class="container-fluid" style="padding-bottom: 20px;">
                   ...
                   <div class="stat-line">
                        <span style="color: #173857; font-size: 13px; padding: 10px;">Date of Current Invoice:
                            <em id="currentInvoiceDate">1000000</em>
                        </span>
                        <span style="color: #173857; font-size: 13px; padding: 10px; margin-left: 10%;;" class="name">Date of Last Paid Invoice:
                            <span id="lastPaidDate" class="number">10,000000</span>
                        </span>
                        <span style="color: #173857; font-size: 13px; padding: 10px; margin-left: 10%;;" class="name">Number of times contacted:
                            <span id="lastPaidDate" class="number">12,000000</span>
                        </span>
                   </div>
                </div>
